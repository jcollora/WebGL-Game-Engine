...
class SimpleShader {
    ...
    constructor(vertexShaderPath, fragmentShaderPath) {
        ...
        // Step E: Activates the vertex buffer from vertex_buffer.js
        gl.bindBuffer(gl.ARRAY_BUFFER, vertexBuffer.get());
        
        // Step F: characteristics of the attribute vertex positions
    ...
    shaderPrimitive(vertexArr) {
        let gl = core.getGL();
        let buffer = vertexBuffer.get();
